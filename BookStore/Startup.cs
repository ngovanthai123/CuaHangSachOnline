...
namespace BookStore
{
    public class Startup
    {
        ...
        .AddSessionStateTempDataProvider();
            ...
            var connectionString = Configuration.GetConnectionString("ShopSachConnection");
            services.AddDbContext<ShopSachContext>(item => item.UseSqlServer(connectionString));
            services.AddDistributedMemoryCache();
